...
raw_path_final_se_g$exposure<-ifelse(raw_path_final_se_g$exposure==0, " no exposure", "5-year exposure")
...
raw_path_continent_se_g[which(raw_path_continent_se_g$exposure==5),]$exposure<-"5-year exposure"
...
raw_path_final_se_g[which(raw_path_final_se_g$exposure==5),]$exposure<-"5-year exposure"
#raw_path_final_se_g$exposure<-factor(raw_path_final_se_g$exposure, levels=c("no exposure", "5-year exposure"))
raw_path_final_se_g$mean_y<-raw_path_final_se_g$mean_y/1000
raw_path_final_se_g$CI_y<-raw_path_final_se_g$CI_y/1000
