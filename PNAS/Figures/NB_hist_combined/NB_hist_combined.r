...
ggsave(pp, filename="../../Figures/NB_hist_combined/NB_hist_combined.png", width=15, height=8)
ggsave(pp, filename="../../Figures/NB_hist_combined/NB_hist_combined.pdf", width=15, height=8)
