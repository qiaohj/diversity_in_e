...
if (F){
  ...
  for (g in c("Amphibians", "Birds", "Mammals", "Reptiles")){
    ...
    saveRDS(when_extinct_df, sprintf("../../Objects/when_where_extinction_5/when_extinct_%s.rda", g))
  }
}
if (F){
  when_extinct<-NULL
  for (g in c("Amphibians", "Birds", "Reptiles", "Mammals")){
    when_extinct_df<-readRDS(sprintf("../../Objects/when_where_extinction_5/when_extinct_%s.rda", g))
  ...
  saveRDS(when_extinct, "../../Objects/when_where_extinction_5/when_extinct_final.rda")
}

when_extinct<-readRDS("../../Objects/when_where_extinction_5/when_extinct_final.rda")
...
p
ggsave(p, filename="../../Figures/when_where_extinction_5/when.pdf", width=8, height=6)
ggsave(p, filename="../../Figures/when_where_extinction_5/when.png", width=8, height=6)

ggsave(p1, filename="../../Figures/when_where_extinction_5/when_number.pdf", width=8, height=4)
ggsave(p1, filename="../../Figures/when_where_extinction_5/when_number.png", width=8, height=4)

ggsave(p2, filename="../../Figures/when_where_extinction_5/when_proportion.pdf", width=8, height=4)
ggsave(p2, filename="../../Figures/when_where_extinction_5/when_proportion.png", width=8, height=4)
