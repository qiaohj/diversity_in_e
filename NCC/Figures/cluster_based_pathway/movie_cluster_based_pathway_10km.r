  ...
  for (exposure in c(5)){
    ...
    for (group in c("Birds", "Mammals")){
      ...
      for (yy in c(2021:2100)){
        ...
        width<-13
        height<-6
        folder<-sprintf("../../Figures/cluster_based_pathway_movies_10km/Movies/exposure_%d/%s/%s/per_%d", 
...
year<-2021
persent<-0.2
base<-sprintf("../../Figures/cluster_based_pathway_movies_10km/Movies/exposure_%d/Combined/%s", 
              exposure, label)
if (!dir.exists(base)){
  dir.create(base)
}
for (year in c(2021:2100)){
  ...
  text(0,100,year,cex=4,font=2)
  
  dev.off()
}

cd /media/huijieqiao/Speciation_Extin/Sp_Richness_GCM/Figures/cluster_based_pathway_movies_10km/Movies/exposure_5/Combined/UKESM1_SSP119
ffmpeg -r 5 -start_number 2021 -i %04d.png -y ../../../UKESM1_SSP119_exposure_5_10km.mp4

cd /media/huijieqiao/Speciation_Extin/Sp_Richness_GCM/Figures/cluster_based_pathway_movies_10km/Movies/exposure_5/Combined/UKESM1_SSP245
ffmpeg -r 5 -start_number 2021 -i %04d.png -y ../../../UKESM1_SSP245_exposure_5_10km.mp4

cd /media/huijieqiao/Speciation_Extin/Sp_Richness_GCM/Figures/cluster_based_pathway_movies_10km/Movies/exposure_5/Combined/UKESM1_SSP585
ffmpeg -r 5 -start_number 2021 -i %04d.png -y ../../../UKESM1_SSP585_exposure_5_10km.mp4
