...
nb_temp<-readRDS("../../Figures/NB_hist_combined/nb_temp_10km.rda")
nb_temp<-nb_temp+theme(strip.background.x = element_blank(),
              strip.text.x = element_blank())
nb_range_size<-readRDS("../../Figures/NB_hist_combined/nb_range_size_10km_2_100km.rda")
disp_dist<-readRDS("../../Figures/NB_hist_combined/disp_dist_10km.rda")
...
ggsave(nb_range_size, filename="../../Figures/NB_hist_combined/nb_range_size_10km.pdf", width=10, height=3)
ggsave(nb_temp, filename="../../Figures/NB_hist_combined/nb_temp_10km.pdf", width=10, height=3)
ggsave(nb_prec, filename="../../Figures/NB_hist_combined/nb_prec_10km.pdf", width=10, height=3)
ggsave(disp_dist, filename="../../Figures/NB_hist_combined/disp_dist_10km.pdf", width=10, height=3)

ggsave(nb_range_size_hist, filename="../../Figures/NB_hist_combined/nb_range_size_hist_10km.pdf", width=4, height=3)
ggsave(nb_temp_hist, filename="../../Figures/NB_hist_combined/nb_temp_hist_10km.pdf", width=4, height=3)
ggsave(nb_prec_hist, filename="../../Figures/NB_hist_combined/nb_prec_hist_10km.pdf", width=4, height=3)
ggsave(disp_dist_hist, filename="../../Figures/NB_hist_combined/disp_dist_hist_10km.pdf", width=4, height=3)
...
pp
ggsave(pp, filename="../../Figures/NB_hist_combined/NB_hist_combined_10km.png", width=15, height=15)
ggsave(pp, filename="../../Figures/NB_hist_combined/NB_hist_combined_10km.pdf", width=15, height=15)
