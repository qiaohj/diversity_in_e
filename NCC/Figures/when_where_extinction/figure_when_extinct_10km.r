...
if (F){
    for (exposure in c(0,5)){
      ...
      for (g in c("Birds", "Mammals")){
        ...
        saveRDS(when_extinct_df, sprintf("../../Objects/when_where_extinction_exposure_%d/when_extinct_%s_10km.rda", exposure, g))
      }
    }
...
if (F){
  ...
  for (exposure in c(0,5)){
    ...
    for (g in c("Birds", "Mammals")){
      sp_list<-readRDS(sprintf("../../Objects/IUCN_List/%s_df.rda", g))
      when_extinct_df<-readRDS(sprintf("../../Objects/when_where_extinction_exposure_%d/when_extinct_%s_10km.rda", exposure, g))
    ...
    saveRDS(when_extinct, sprintf("../../Objects/when_where_extinction_exposure_%d/when_extinct_final_10km.rda", exposure))
  }
...
if (F){
  ...
  for (exposure in c(0,5)){
    when_extinct<-readRDS(sprintf("../../Objects/when_where_extinction_exposure_%d/when_extinct_final_10km.rda", exposure))
    ...
    p
    ggsave(p, filename=sprintf("../../Figures/when_where_extinction_exposure_%d/when_10km.pdf", exposure), width=8, height=6)
    ggsave(p, filename=sprintf("../../Figures/when_where_extinction_exposure_%d/when_10km.png", exposure), width=8, height=6)
    
    ggsave(p1, filename=sprintf("../../Figures/when_where_extinction_exposure_%d/when_number_10km.pdf", exposure), width=8, height=4)
    ggsave(p1, filename=sprintf("../../Figures/when_where_extinction_exposure_%d/when_number_10km.png", exposure), width=8, height=4)
    
    ggsave(p2, filename=sprintf("../../Figures/when_where_extinction_exposure_%d/when_proportion_10km.pdf", exposure), width=8, height=4)
    ggsave(p2, filename=sprintf("../../Figures/when_where_extinction_exposure_%d/when_proportion_10km.png", exposure), width=8, height=4)
  }
  
}


  when_extinct_1<-readRDS(sprintf("../../Objects/when_where_extinction_exposure_%d/when_extinct_final_10km.rda", 0))
  ...
  when_extinct_5<-readRDS(sprintf("../../Objects/when_where_extinction_exposure_%d/when_extinct_final_10km.rda", 5))
  ...
  p1
  ggsave(p1, filename=sprintf("../../Figures/when_where_extinction_all/when_number_10km.pdf"),
         width=11, height=6)
  ggsave(p1, filename=sprintf("../../Figures/when_where_extinction_all/when_number_10km.png"),
         width=11, height=6)
  ...
  p2
  ggsave(p2, filename=sprintf("../../Figures/when_where_extinction_all/when_proportion_10km.pdf"),
         width=11, height=6)
  ggsave(p2, filename=sprintf("../../Figures/when_where_extinction_all/when_proportion_10km.png"),
         width=11, height=6)
  
  
  write.csv(when_extinct,
            sprintf("../../Figures/when_where_extinction_all/when_extinct_10km.csv"))
