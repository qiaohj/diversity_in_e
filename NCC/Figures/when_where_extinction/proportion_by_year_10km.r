...
sp_mean<-read.csv(sprintf("../../Figures/when_where_extinction_all/when_extinct_10km.csv"), stringsAsFactors = F)
...
write.table(result, "../../Figures/when_where_extinction_all/proportion_by_year_10km.csv", row.names=F, sep=",")
