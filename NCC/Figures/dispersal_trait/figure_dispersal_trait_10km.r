...
if (F){
  ...
  for (exposure in c(0, 5)){
    for (g in c("Birds", "Mammals")){
      df<-readRDS(sprintf("../../Objects/dispersal_trait_10km/dispersal_trait_exposure_%d_%s.rda", exposure, g))
      df$group<-g
      if (is.null(df_all)){
        df_all<-df
      }else{
  ...
  saveRDS(df_all, "../../Objects/dispersal_trait/all_10km.rda")
}
df_all<-readRDS("../../Objects/dispersal_trait/all_10km.rda")
...
write.csv(df_se, sprintf("../../Figures/dispersal_traits/gradient_%s_10km.csv", "ALL"), row.names=F)
ggsave(pp2, filename=sprintf("../../Figures/dispersal_traits/gradient_%s_10km.png", "ALL"), width=10, height=8)
ggsave(pp2, filename=sprintf("../../Figures/dispersal_traits/gradient_%s_10km.pdf", "ALL"), width=10, height=8)
...
for (SSP_l in SSPs){
  ...
  ggsave(pp2, filename=
           sprintf("../../Figures/dispersal_traits/gradient_%s_combined_%s_10km.png", "ALL", SSP_l), 
         width=3.5, height=4)
  ggsave(pp2, filename=
           sprintf("../../Figures/dispersal_traits/gradient_%s_combined_%s_10km.pdf", "ALL", SSP_l), 
         width=4, height=6)
...
#write.csv(raw_path_final_se_g, sprintf("../../Figures/Top_Figure_all/gradient_%s_ttt_%d.csv", "ALL", ttt), row.names=F)
ggsave(pp2, filename=
         sprintf("../../Figures/dispersal_traits/gradient_%s_combined_all_sp_10km.png", "ALL"), 
       width=4, height=8)
ggsave(pp2, filename=
         sprintf("../../Figures/dispersal_traits/gradient_%s_combined_all_sp_10km.pdf", "ALL"), 
       width=4, height=8)
...
#write.csv(raw_path_final_se_g, sprintf("../../Figures/Top_Figure_all/gradient_%s_ttt_%d.csv", "ALL", ttt), row.names=F)
ggsave(pp2, filename=sprintf("../../Figures/dispersal_traits/gradient_%s_by_tropics_ns_10km.png", 
                             "ALL"), width=10, height=10)
ggsave(pp2, filename=sprintf("../../Figures/dispersal_traits/gradient_%s_by_tropics_ns_10km.pdf", 
...
#write.csv(raw_path_final_se_g, sprintf("../../Figures/Top_Figure_all/gradient_%s_ttt_%d.csv", "ALL", ttt), row.names=F)
ggsave(pp2, filename=sprintf("../../Figures/dispersal_traits/gradient_%s_by_tropics_ns_alt_10km.png", 
                             "ALL"), width=10, height=10)
ggsave(pp2, filename=sprintf("../../Figures/dispersal_traits/gradient_%s_by_tropics_ns_alt_10km.pdf", 
                             "ALL"), width=12, height=8)
