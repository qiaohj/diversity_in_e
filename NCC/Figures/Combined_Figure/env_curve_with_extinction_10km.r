...
extinct_propotion<-read.csv("../../Figures/when_where_extinction_all/proportion_by_year_10km.csv",
                            stringsAsFactors = F)
...
p2
ggsave(p2, filename="../../Figures/Combined_Figure/Figure_env_year_10km.pdf", width=10, height=6)
ggsave(p2, filename="../../Figures/Combined_Figure/Figure_env_year_10km.png", width=10, height=6)
...
p2<-ggplot()+
  ...
  #theme(legend.position = "bottom", legend.box="vertical")
p2
ggsave(p2, filename="../../Figures/Combined_Figure/Figure_env_year_few_10km.pdf", width=12, height=6)
ggsave(p2, filename="../../Figures/Combined_Figure/Figure_env_year_few_10km.png", width=12, height=6)

write.csv(extinct_propotion_with_sp, "../../Figures/Combined_Figure/extinct_propotion_with_sp_10km.csv")
