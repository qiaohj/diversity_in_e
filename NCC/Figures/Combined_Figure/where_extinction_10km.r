...
if (T){
  ...
  for (ll in unique(n_ext_final_with_keyspots$label)){
    ...
    ggsave(p2_insert, filename=sprintf("../../Figures/Combined_Figure/keyspots_extinction_%s_%s_10km.png", 
...
p3
ggsave(p3, filename=sprintf("../../Figures/Combined_Figure/keyspots_extinction_%s_10km.pdf", SSPi), width=12, height=6)
ggsave(p3, filename=sprintf("../../Figures/Combined_Figure/keyspots_extinction_%s_10km.png", SSPi), width=12, height=6)
